...
// GetTable provides a mock function with given fields: ctx, table
func (_m *MaxComputeClient) GetTable(ctx context.Context, table *odps.Table) (*odps.Table, error) {
	...
	var r0 *odps.Table
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *odps.Table) (*odps.Table, error)); ok {
		return rf(ctx, table)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *odps.Table) *odps.Table); ok {
		r0 = rf(ctx, table)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *odps.Table) error); ok {
		r1 = rf(ctx, table)
	} else {
		r1 = ret.Error(1)
	}
...
// MaxComputeClient_GetTable_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTable'
type MaxComputeClient_GetTable_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - table *odps.Table
func (_e *MaxComputeClient_Expecter) GetTable(ctx interface{}, table interface{}) *MaxComputeClient_GetTable_Call {
	return &MaxComputeClient_GetTable_Call{Call: _e.mock.On("GetTable", ctx, table)}
}

func (_c *MaxComputeClient_GetTable_Call) Run(run func(ctx context.Context, table *odps.Table)) *MaxComputeClient_GetTable_Call {
...
func (_c *MaxComputeClient_GetTable_Call) Return(_a0 *odps.Table, _a1 error) *MaxComputeClient_GetTable_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MaxComputeClient_GetTable_Call) RunAndReturn(run func(context.Context, *odps.Table) (*odps.Table, error)) *MaxComputeClient_GetTable_Call {
	_c.Call.Return(run)
	return _c
}
